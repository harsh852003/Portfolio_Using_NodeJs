        ...
        <div>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <textarea name='message' id='message' className='bg-orange-100 border border-orange-400 placeholder-orange-300 text-orange-500 rounded-lg block w-full p-2' placeholder="talk about"></textarea>
            </div>
