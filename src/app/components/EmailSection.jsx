    ...
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24' id='email'>
      ...
      <div>
        <form className='flex flex-col gap-4' onSubmit={handleSubmit} >
          ...
          <input  name='subject' type='subject' id='subject' required  className=' bg-orange-100 border border-orange-400 placeholder-orange-300 text-orange-500 rounded-lg block w-full p-2' placeholder=' Say hii'/>
          </div>
          <div>
