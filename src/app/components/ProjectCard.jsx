...
function ProjectCard({ imgUrl, title, description }) {
    return (
        <div>
            <div className='h-72 w-72 md:h-60 md:w-96 rounded-xl relative group bg-center bg-no-repeat' style={{ background: `url(${imgUrl})`, backgroundSize: "contain" }}>
            ...
            <Link href="/" className='h-14 w-14 border-2 relative rounded-full border-orange-200 hover:border-orange-50 group/link'>
            ...
            <Link href="/" className=' ml-2 h-14 w-14 border-2 relative rounded-full border-orange-200 hover:border-orange-50 group/link'>
